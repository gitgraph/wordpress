...
<div id="content"> 
    ...
    <div class="container"> 
        ...
        <div id="main" class="main"> <?php if (have_posts()): ?> <?php $c = 0; ?> 
                <ul id="index"> <?php if (is_category()) { ?> 

                        <div id="jbox"><h2> <?php single_tag_title(); ?></h2> 
                        </div> <?php } ?> <?php if (is_date()) { ?> 

                        <div id="jbox"> <h2><?php single_month_title(' '); ?> </h2> 
                        </div><?php } ?> <?php while (have_posts()): the_post(); ?> <?php $c++; ?> 
