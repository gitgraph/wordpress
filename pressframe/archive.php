<?php get_header(); ?> <section id="s2" class="section"> 
    ...
    <script type='text/javascript'> open = 'archive';
    </script> 
    ...
    <div id="hdiv2" class="page2"> 
        ...
        <div id="hdmain"> 
            ...
            ?>"> <?php if (get_theme_mod('pside') === '3') { ?> <section id="hsec3" class="asec"> 
                        ...
                        <div id="swid" class="widgets" style="padding: 120px 0px;"> <?php dynamic_sidebar('sidebar'); ?> 
                        </div> </section> <?php } ?> <section id="hsec1" class="asec"> <?php get_template_part('latestpost') ?> </section> <?php if (get_theme_mod('pside') === '5') { ?> <section id="hsec3" class="asec"> 
