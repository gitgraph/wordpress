<?php /* Template Name: Blog */ ?><?php get_header(); ?> <section id="s2" class="section"> 

    <div id="dh1"> <h1>...open</h1> 
    </div> 
    <script type='text/javascript'> open = 'blog';
    </script> 
    ...
    <div id="hdiv2" class="page2"> 
        ...
        <div id="hdmain"> 
            ...
            ?>"> <?php if (get_theme_mod('pside') === '3') { ?> <section id="hsec3" class="asec"> 
                        ...
                        </div> </section> <?php } ?> <section id="hsec1" class="asec"> <?php get_template_part('blog') ?> </section> <?php if (get_theme_mod('pside') === '5') { ?> <section id="hsec3" class="asec"> 
